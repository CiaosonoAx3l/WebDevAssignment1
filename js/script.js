...
typeEffect(compareText, "Find out how different PC builds perform and discover which components are worth it and which not.", 0);
typeEffect(createText, "Experiment with CPU(processor), GPU(graphic card), and RAM combinations, and see how they affect your total price and performance.", 0);
typeEffect(tailorText, "From basic setups for essays to high-end machines for engineering, I've got practical advice for every budget.", 0);
...
faqButtons.forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    answerBox.textContent = typeEffect(answerBox, response, 3);
